...
<div id="right">
    <form id="form" action="/dept/addDept" method="post">
        部门：<input type="text" name="name" id="name"><label id="name-label"></label><br><br>

        <input type="button" id="btn" class="btn btn-success" value="添加">
